...
export function analysisMessages({ message, history, marketContext, image, historicalMarket = null, tradeContext = null, autoMarket = null, newsContext = null }) {
